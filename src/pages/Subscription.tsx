    ...
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Choose Your Green Impact Plan
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Join thousands of environmentally conscious individuals and
      ...
      <div className="bg-green-50 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Try any paid plan risk-free. If you're not completely satisfied within
          the first 30 days, we'll refund your payment in full. No questions
          asked.
        </p>
      </div>
    </div>
