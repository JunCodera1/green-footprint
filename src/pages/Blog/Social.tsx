...
export const SocialPage: React.FC<SocialPageProps> = ({ isDarkMode = false }) => {
  const [activeTab, setActiveTab] = useState<'feed' | 'friends' | 'teams'>('feed');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {profiles.length === 0 && (
              ...
              >
                ...
                <p className="text-sm">Start connecting with other eco-conscious individuals</p>
              </div>
            )}
          </div>
        )}
            ...
            {teams.map((team) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <img src={team.avatar} alt={team.name} className="w-12 h-12 rounded-full" />
                </div>
