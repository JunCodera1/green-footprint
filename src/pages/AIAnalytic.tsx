    ...
    >
      ...
      <div
        className={`bg-gradient-to-r from-green-300 to-teal-600 text-white py-16 shadow-lg ${
          isDarkMode ? "dark:from-gray-800 dark:to-gray-900" : ""
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 text-green-200">
            <p>
              🌱 {data?.recommendations.length} personalized recommendations for
      ...
      <PageTransition>
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Additional CTA */}
          <div
            className={`mt-8 p-6 rounded-xl shadow-lg transition-colors duration-300 ${
              isDarkMode ? "bg-gray-800" : "bg-white"
            }`}
          >
            <h2
