...
export const EducationPage: React.FC<EducationPageProps> = ({ isDarkMode = false }) => {
              ...
              >
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span
                          className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}
                        >
                          {webinar.recording?.available ? 'Recording available' : 'Live only'}
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col items-end">
                    <div className="flex items-center mb-2">
                      ...
                      <div
                        className={`w-2 h-2 rounded-full ${
                          webinar.registrations >= webinar.capacity ? 'bg-red-500' : 'bg-green-500'
                        }`}
                      />
                    </div>
                    <button
                    ...
                    >
                      {webinar.registrations >= webinar.capacity ? 'Fully Booked' : 'Register Now'}
                    </button>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                        {webinar.speaker.title} at {webinar.speaker.organization}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    >
                      <li>{certification.requirements.quizzes.length} Quizzes</li>
                      <li>{certification.requirements.tutorials.length} Tutorials</li>
                      {certification.requirements.projects && (
                        <li>{certification.requirements.projects.length} Projects</li>
                      )}
                    </ul>
                  </div>
                  <div>
            ...
            {certifications.length === 0 && (
              ...
              >
                ...
                <p className="text-sm">Check back later for new certification programs</p>
              </div>
            )}
          </div>
        )}
