...
import type { Achievement, Challenge, UserProgress } from '../../types/achievement';
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className={isDarkMode ? 'text-gray-300' : 'text-gray-900'}>
                    {mockProgress.currentPoints}/{mockProgress.pointsToNextLevel}
                  </span>
                </div>
                <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${
                        (mockProgress.currentPoints / mockProgress.pointsToNextLevel) * 100
                      }%`,
                    }}
                  />
                </div>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg p-6`}>
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
                >
                  {mockProgress.completedAchievements}/{mockProgress.totalAchievements}
                </span>
              </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex space-x-2">
                {['all', 'reduction', 'lifestyle', 'community'].map((category) => (
                  <button
                    key={category}
