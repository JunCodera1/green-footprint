...
const APIDocumentation: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div
        className={`bg-gradient-to-r from-green-300 to-teal-600 text-white py-16 ${
          isDarkMode ? "dark:from-green-800 dark:to-teal-800" : ""
        }`}
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div
          className={`rounded-lg shadow-xl p-6 mb-8 transition-colors duration-300 ${
