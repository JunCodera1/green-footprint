...
const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    ...
    >
      ...
      {isMenuOpen && (
        <div
          className={`md:hidden backdrop-blur-lg ${isDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}
        >
            ...
            {!isAuthPage && (
              <>
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                >
                  Features
                </a>
                <a
